...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., add_bias_kv=False, add_zero_attn=False,
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_weights = nn.functional.multi_head_attention_forward(
                ...
                self.in_proj_weight.get_weight(), self.in_proj_weight.get_bias(),
                self.bias_k, self.bias_v, self.add_zero_attn,
                self.dropout, self.out_proj.get_weight(), self.out_proj.get_bias(),
                training=self.training,
                key_padding_mask=key_padding_mask, need_weights=need_weights,
                attn_mask=attn_mask, use_separate_proj_weight=True,
                q_proj_weight=self.q_proj_weight.get_weight(), k_proj_weight=self.k_proj_weight.get_weight(),
